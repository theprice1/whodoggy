...
import InfoDialog from "../components/InfoDialog.js.js";
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.text}>
          ...
          dog records by entering the microchip ID.{"\n"}- View details about the dog and its owner.
          {"\n"}- Use the info button below for additional app information.
        </Text>

        <Text style={styles.sectionTitle}>Privacy & Security</Text>
        <Text style={styles.text}>
          Your data is securely handled in compliance with privacy laws. Only authorized users can
