  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <Text style={styles.paragraph}>
        Welcome to WhoDoggy?. By using this app, you agree to comply with and be bound by the
      ...
      <Text style={styles.paragraph}>
        All content, trademarks, and data within the app are the property of WhoDoggy? and its
        licensors.
      </Text>
