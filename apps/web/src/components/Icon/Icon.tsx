...
function getColorFilter(color: string): string {
	const colorMap: Record<string, string> = {
		"#2D89EF":
			"invert(42%) sepia(93%) saturate(1352%) hue-rotate(204deg) brightness(97%) contrast(103%)",
		"#F5A623":
			"invert(64%) sepia(100%) saturate(1374%) hue-rotate(6deg) brightness(100%) contrast(98%)",
	};
