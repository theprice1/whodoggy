...
const realRegistries = [
  { id: 1, name: "AnimalData", country: "UK", website: "animaldata.org.uk", port: 4101 },
  { id: 2, name: "Animal Microchips", country: "UK", website: "animalmicrochips.co.uk", port: 4102 },
  { id: 3, name: "Animal Tracker", country: "UK", website: "animaltracker.co.uk", port: 4103 },
  { id: 4, name: "Chipworks", country: "UK", website: "chipworks.co.uk", port: 4104 },
  { id: 5, name: "HomeAgain", country: "UK", website: "homeagain.co.uk", port: 4105 },
  { id: 6, name: "Identibase", country: "UK", website: "identibase.co.uk", port: 4106 },
  { id: 7, name: "Lost Paws", country: "UK", website: "lostpaws.co.uk", port: 4107 },
  { id: 8, name: "MicroChip Central", country: "UK", website: "microchipcentral.com", port: 4108 },
  { id: 9, name: "MicroDogID", country: "UK", website: "microdogid.org", port: 4109, note: "Racing greyhounds only" },
  { id: 10, name: "My Animal Trace", country: "UK", website: "myanimaltrace.com", port: 4110 },
  { id: 11, name: "MyPet", country: "UK", website: "mypethq.io", port: 4111 },
  { id: 12, name: "National Veterinary Data Service", country: "UK", website: "nvds.co.uk", port: 4112 },
  { id: 13, name: "Pet Chip Register", country: "UK", website: "petchipregister.co.uk", port: 4113 },
  { id: 14, name: "Pet Database", country: "UK", website: "petdatabase.com", port: 4114 },
  { id: 15, name: "Pet Identity UK", country: "UK", website: "petidentityuk.info", port: 4115 },
  { id: 16, name: "Petlog", country: "UK", website: "petlog.org.uk", port: 4116, note: "UK's largest database" },
  { id: 17, name: "PetScanner", country: "UK", website: "petscanner.com", port: 4117 },
  { id: 18, name: "ProtectedPet", country: "UK", website: "protectedpet.com", port: 4118 },
  { id: 19, name: "SmartTrace", country: "UK", website: "smarttrace.org.uk", port: 4119 },
  { id: 20, name: "Track Your Paws", country: "UK", website: "trackyourpaws.co.uk", port: 4120 },
  { id: 21, name: "UK PETtrac MicroChip Database", country: "UK", website: "pettrac.co.uk", port: 4121 },
  { id: 22, name: "We Trace Pets", country: "UK", website: "wetracepets.com", port: 4122 }
];
  ...
  app.get('/', async (req, res) => {
    try {
      ...
      res.json({
        ...
        services: ['Microchip registration', 'Lost pet reunification', '24/7 lookup service'],
...
async function startAllRegistries() {
  console.log('🐕 Starting Real UK/Northern Ireland Microchip Registry Services');
  ...
  setTimeout(async () => {
    ...
    try {
      ...
      console.log('   used by vets, rescue centers, and dog wardens for pet identification.');
