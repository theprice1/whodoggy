    ...
    const registriesData = [
        {
            ...
            country: "USA",
            contact: "contact@globalmicrochips.com",
        },
        {
            name: "EuroPet Registry",
            country: "Germany",
            contact: "info@europet.de",
        },
        {
            name: "Canine Connect",
            country: "UK",
            contact: "support@canineconnect.co.uk",
        },
        {
            name: "Dog ID International",
            country: "France",
            contact: "contact@dogid.fr",
        },
        {
            name: "PetSafe Registry",
            country: "Canada",
            contact: "registry@petsafe.ca",
        },
        {
            name: "Microchip World",
            country: "Australia",
            contact: "info@microchipworld.au",
        },
        {
            name: "AnimalTrack",
            country: "Netherlands",
            contact: "support@animaltrack.nl",
        },
        {
            name: "PetLink Global",
            country: "USA",
            contact: "hello@petlinkglobal.com",
        },
        {
            name: "Fido Registry",
            country: "UK",
            contact: "contact@fidoregistry.co.uk",
        },
        ...
        {
            name: "Global Paw Registry",
            country: "USA",
            contact: "hello@globalpaw.com",
        },
        {
            name: "Canine ID Network",
            country: "Canada",
            contact: "info@canineid.ca",
        },
        {
            name: "Pet Passport Registry",
            country: "Australia",
            contact: "contact@petpassport.au",
        },
        { name: "DogSafe", country: "Netherlands", contact: "support@dogsafe.nl" },
        { name: "ID My Dog", country: "UK", contact: "info@idmydog.co.uk" },
        {
            name: "Pet Tracker Intl",
            country: "USA",
            contact: "hello@pettracker.com",
        },
        {
            name: "Microchip Solutions",
            country: "Germany",
            contact: "contact@microchipsolutions.de",
        },
        {
            name: "DogRegistry Europe",
            country: "France",
            contact: "support@dogregistry.fr",
        },
        { name: "Global PetID", country: "Canada", contact: "info@globalpetid.ca" },
        {
            name: "PawSecure",
            country: "Australia",
            contact: "contact@pawsecure.au",
        },
    ];
    const registries = [];
