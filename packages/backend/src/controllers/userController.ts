import type { Request, Response } from "express"; // Importing types for Express

// Controller function to handle GET /api/users
export const _getUsers = (_req: Request, res: Response) => {
	res.status(200).json({ message: "Fetching all users" });
};

// Controller function to handle POST /api/users
export const _createUser = (req: Request, res: Response) => {
