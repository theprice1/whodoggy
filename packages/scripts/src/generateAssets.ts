...
const ASSET_CONFIGS: AssetConfig[] = [
	// App Icons from logo-icon-only.svg
	{
		...
		outputs: [
			...
			// iOS app icon sizes
			{
				path: "apps/mobile/ios/WhoDoggy/Images.xcassets/AppIcon.appiconset/icon-1024.png",
				width: 1024,
				height: 1024,
				format: "png",
			},
			{
				path: "apps/mobile/ios/WhoDoggy/Images.xcassets/AppIcon.appiconset/icon-180.png",
				width: 180,
				height: 180,
				format: "png",
			},
			{
				path: "apps/mobile/ios/WhoDoggy/Images.xcassets/AppIcon.appiconset/icon-120.png",
				width: 120,
				height: 120,
				format: "png",
			},
			{
				path: "apps/mobile/ios/WhoDoggy/Images.xcassets/AppIcon.appiconset/icon-60.png",
				width: 60,
				height: 60,
				format: "png",
			},
			...
			{
				path: "apps/mobile/android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png",
				width: 192,
				height: 192,
				format: "png",
			},
			{
				path: "apps/mobile/android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png",
				width: 144,
				height: 144,
				format: "png",
			},
			{
				path: "apps/mobile/android/app/src/main/res/mipmap-xhdpi/ic_launcher.png",
				width: 96,
				height: 96,
				format: "png",
			},
			{
				path: "apps/mobile/android/app/src/main/res/mipmap-hdpi/ic_launcher.png",
				width: 72,
				height: 72,
				format: "png",
			},
			{
				path: "apps/mobile/android/app/src/main/res/mipmap-mdpi/ic_launcher.png",
				width: 48,
				height: 48,
				format: "png",
			},
			...
			{
				path: "apps/web/public/logo192.png",
				width: 192,
				height: 192,
				format: "png",
			},
			{
				path: "apps/web/public/logo512.png",
				width: 512,
				height: 512,
				format: "png",
			},
	...
	// Splash screens from splash-mobile.svg
	{
		...
		outputs: [
			...
			{
				path: "apps/mobile/assets/splash@2x.png",
				width: 2484,
				height: 5376,
				format: "png",
			},
	...
	...[
		...
		outputs: [
			// Mobile PNG versions
			{
				path: `apps/mobile/src/assets/icons/${iconName}.png`,
				width: 24,
				height: 24,
				format: "png" as const,
			},
			{
				path: `apps/mobile/src/assets/icons/${iconName}@2x.png`,
				width: 48,
				height: 48,
				format: "png" as const,
			},
			{
				path: `apps/mobile/src/assets/icons/${iconName}@3x.png`,
				width: 72,
				height: 72,
				format: "png" as const,
			},
			...
			{
				path: `apps/web/public/assets/icons/${iconName}.svg`,
				width: 24,
				height: 24,
				format: "svg" as const,
			},
			...
			// Shared assets
			{
				path: `packages/shared/src/assets/icons/${iconName}.svg`,
				width: 24,
				height: 24,
				format: "svg" as const,
			},
